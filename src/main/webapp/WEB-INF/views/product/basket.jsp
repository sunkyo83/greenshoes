  ...
  <div id="container">
    ...
    <div class="cart">
          ...
          <form>
            ...
            <tbody>
              <tr class="cart_list_detail">
                <td><input type="checkbox"></td>
                <td><span class="cart_img"><img src="../image/addidas2.png" alt="magic keyboard"></span></td>
                <td><p>adidas</p>
              ...
              <tr class="cart_list_detail">
                ...
                <td style="width: 13%;">
                <span class="cart_img"><img src="../image/addidas2.png" alt="magic mouse"></span>
                </td>
      ...
      <div class="pay">
        ...
        <div class="buy_button"><a href=""><button type="submit">구매하기</button></a></div>
      </div>
